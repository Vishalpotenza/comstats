                   ...
                   <form class="edit_admin_form" id="edit_admin_form" method="POST" enctype="multipart/form-data">
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="first_name" name="first_name" value="<?= $admin_data['first_name'] ?>" >
                      </div>
					  <div class="form-group col-md-6">
                        <label for="last_name">Last Name</label>
                        <input type="text" class="form-control" id="last_name" name="last_name" value="<?= $admin_data['last_name'] ?>">
                      </div>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="tel" class="form-control" id="email" name="email" value="<?= $admin_data['email'] ?>" disabled>
                      </div>
                    </div>
