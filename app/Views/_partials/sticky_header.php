      <nav class="navbar navbar-expand-lg main-navbar sticky">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown"
              class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src="<?=  base_url().IMGPATH ?>/user.png"
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
              ...
              <a href="<?= base_url().'/admin/profile'?>" class="dropdown-item has-icon"> <i class="far
                ...
                Update Password
              </a> <a href="#" class="dropdown-item has-icon firebase_setting"> <i class="fas fa-cog"></i>
                Firebase
              </a>
